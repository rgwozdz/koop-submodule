describe('modify-package-scripts', () => {
  ...
  test('should modify with node_modules copy', async () => {
    await modifyPackageScripts('path/to', '../../other/path');
    expect(util.modifyJsonFile.mock.calls[0]).toEqual([
      'path/to/core/package.json', {
        scripts: {
          "build": "shx mkdir ../../other/path/core && shx cp package.json ../../other/path/core && shx cp -r ./src ../../other/path/core && shx cp -r ./node_modules ../../other/path/core",
